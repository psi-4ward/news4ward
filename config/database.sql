...
CREATE TABLE `tl_module` (
  ...
  `news4ward_readerTemplate` varchar(32) NOT NULL default '',
  ...
  `news4ward_ignoreFilters` char(1) NOT NULL default '',
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
