 ...
 */
$GLOBALS['TL_DCA']['tl_user_group']['palettes']['default'] = str_replace('fop;', 'fop;{news4ward_legend},news4ward,news4ward_newp;', $GLOBALS['TL_DCA']['tl_user_group']['palettes']['default']);
